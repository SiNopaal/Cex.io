...
class Tapper:
    ...
    async def get_tg_web_data(self, proxy: str | None) -> str:
        ...
        # Perbaikan penanganan ref_param
        try:
            ref_param = settings.REF_LINK.split('=')[1] if settings.REF_LINK and '=' in settings.REF_LINK else "1729787267560018"
        except:
            ref_param = "1729787267560018"
